 ...
 * <td>This component loads data to Informix database using dbload utility. 
 * There is created temporary file with dbload commands depending on input parameters. Data are read from given 
 * input file or from input port and loaded to database. On Linux/Unix system data transfer is processed by stdio.<br>
