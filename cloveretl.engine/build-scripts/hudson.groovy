...
assert buildNumber
jobNameM = jobName =~ /^(cloveretl\.engine)-((tests-night-java-1.6-IBM|tests-night-java-1.6-JRockit|tests-night-functional|tests-after-commit|tests-reset|tests-performance|detail)-)?(.+)$/
