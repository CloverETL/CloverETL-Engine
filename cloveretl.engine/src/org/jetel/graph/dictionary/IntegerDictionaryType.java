 ...
 * @created Jun 21, 2010
 */
public class IntegerDictionaryType extends DictionaryType {
	 ...
	 * Constructor.
	 */
	public IntegerDictionaryType() {
		super(TYPE_ID, Integer.class);
	}
	...
	public Properties formatProperties(Object value) {
		if (value != null) {
			...
			result.setProperty(VALUE_ATTRIBUTE, ((Integer) value).toString());
			return result;
		} else {
			return null;
		}
