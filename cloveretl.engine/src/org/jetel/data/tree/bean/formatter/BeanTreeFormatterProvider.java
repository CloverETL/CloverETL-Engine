 ...
 * @created 4.11.2011
 */
public class BeanTreeFormatterProvider extends BaseTreeFormatterProvider {
	
	private SchemaObject structure;
	private ClassLoader classloader;

	public BeanTreeFormatterProvider(WritableMapping mapping, int maxPortIndex, SchemaObject structure, ClassLoader classloader) {
	...
	public TreeFormatter getNewFormatter() {
		return new BeanTreeFormatter(mapping, maxPortIndex, structure, classloader);
	}
