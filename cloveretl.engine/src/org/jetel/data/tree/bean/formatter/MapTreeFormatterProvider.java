 ...
 * @created 1.2.2012
 */
public class MapTreeFormatterProvider extends BaseTreeFormatterProvider {

	public MapTreeFormatterProvider(WritableMapping mapping, int maxPortIndex) {
		super(mapping, maxPortIndex);
	}

	@Override
	public Formatter getNewFormatter() {
		return new MapTreeFormatter(mapping, maxPortIndex);
	}
