 ...
 * @created 3.1.2012
 */
public class JsonTreeFormatterProvider extends BaseTreeFormatterProvider {

	private String encoding;
	private boolean omitNewLines;
	
	public JsonTreeFormatterProvider(WritableMapping mapping, int maxPortIndex, String encoding, boolean omitNewLines) {
	...
	public TreeFormatter getNewFormatter() {
		return new JsonTreeFormatter(mapping, maxPortIndex, encoding, omitNewLines);
	}
