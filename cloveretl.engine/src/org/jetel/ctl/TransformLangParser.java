        ...
        throw new ParseException();
          ...
          jjtc000 = false;
                ...
                if (!isParsedImport(filenameURL)) {
                        ...
                        final URL projectURL = graph != null ? graph.getProjectURL() : null;

                        jjtn000.setSourceToImport(filenameURL);
                        CLVFStart parseTree = null;
                        try {
                                stream=Channels.newInputStream(FileUtils.getReadableChannel(projectURL, filenameURL));
                                addParsedImport(filenameURL); // the above will handle invalid URL etc.
                                problemReporter.setImport(filenameURL); // problem reporter is singleton so the new parser will get the same
                                ...
                                // we continue parsing the current file regardless of errors
                                problemReporter.setImport(null);
                        }
                }
    } finally {
          if (jjtc000) {
  ...
  jjtree.openNodeScope(jjtn000);
    try {
      ...
      case BYTE_VAR:
        ...
        break;
      case CBYTE_VAR:
        jj_consume_token(CBYTE_VAR);
                          jjtree.closeNodeScope(jjtn000, true);
                          jjtc000 = false;
                        jjtn000.begin(token.beginLine,token.beginColumn);
                        jjtn000.end(token.endLine,token.endColumn);
                        jjtn000.setKind(CBYTE_VAR);
        break;
      case BOOLEAN_VAR:
...
// Formal root of expressions, delegates to AssignmentExpression
      ...
      case MAPPING:
        ...
        default:
          ...
          throw new ParseException();
                ...
                // The check can't be done immediately after ConditionalExpression()
 ...
 /*@bgen(jjtree) #UnaryExpression( isPrefix) */
  ...
  final public void PrefixOp(CLVFUnaryExpression expr) throws ParseException {
    switch (jj_nt.kind) {
    case INCR:
 ...
 /*@bgen(jjtree) #PostfixExpression( isPostfix) */
  ...
  final public void BuiltInFunctionCall() throws ParseException {
    ...
    case RAISE_ERROR:
      ...
      break;
    case READ_DICT:
      t = jj_consume_token(READ_DICT);
      Arguments(null);
                                               CLVFReadDictNode jjtn009 = new CLVFReadDictNode(this, JJTREADDICTNODE);
      ...
      break;
    case WRITE_DICT:
      t = jj_consume_token(WRITE_DICT);
      Arguments(null);
                                                CLVFWriteDictNode jjtn010 = new CLVFWriteDictNode(this, JJTWRITEDICTNODE);
                                                boolean jjtc010 = true;
                                                jjtree.openNodeScope(jjtn010);
      try {
                                                jjtree.closeNodeScope(jjtn010,  1);
                                                jjtc010 = false;
                                                jjtn010.begin(t.beginLine,t.beginColumn);
      } finally {
                                                if (jjtc010) {
                                                  jjtree.closeNodeScope(jjtn010,  1);
                                                }
      ...
      break;
    case DELETE_DICT:
      t = jj_consume_token(DELETE_DICT);
      Arguments(null);
                                                 CLVFDeleteDictNode jjtn011 = new CLVFDeleteDictNode(this, JJTDELETEDICTNODE);
                                                 boolean jjtc011 = true;
                                                 jjtree.openNodeScope(jjtn011);
      try {
                                                 jjtree.closeNodeScope(jjtn011,  1);
                                                 jjtc011 = false;
                                                 jjtn011.begin(t.beginLine,t.beginColumn);
      } finally {
                                                 if (jjtc011) {
                                                   jjtree.closeNodeScope(jjtn011,  1);
                                                 }
    ...
    try {
      ...
      jj_consume_token(FIELD_IDENTIFIER);
           ...
           jjtc000 = false;
                ...
                int dotPos;
                if ((dotPos = token.image.indexOf('.') ) > 0 ) {
                        String recId = token.image.substring(0,dotPos);
                        try {
                                Integer recNum = Integer.parseInt(recId);
                                // set directly the position access 
                                jjtn000.setRecordId(recNum);
                        } catch (NumberFormatException e) {
                                jjtn000.setRecordName(recId);
                        }

                        String fieldId = token.image.substring(dotPos+1);
                        if (fieldId.equals("*")) {
                        ...
                        try {
                                Integer fieldNum = Integer.parseInt(token.image);
                                // set directly the position access
                                jjtn000.setFieldId(fieldNum);
                        } catch (NumberFormatException e) {
                                // set the field name
                                jjtn000.setFieldName(token.image);
                        }
                }
    } finally {
           if (jjtc000) {
    ...
    try {
      ...
      case RETURN_OK:
        jj_consume_token(RETURN_OK);
               jjtn000.setType(TLTypePrimitive.INTEGER); jjtn000.setValueDirect(0);
        break;
      case RETURN_SKIP:
...
//void EvalNode() ://{}//{//   "eval(" AdditiveExpression() ["," AdditiveExpression() ] ")" { hasEvalNode=true;  jjtThis.setExpMode(false); }//   | "eval_exp(" AdditiveExpression() ")" { jjtThis.setExpMode(true); }//}  final public void SequenceNode() throws ParseException {
 ...
 /*@bgen(jjtree) LookupNode */
  ...
  private boolean jj_3R_138() {
    ...
    if (jj_scan_token(FIELD_IDENTIFIER)) return true;
    return false;
  }
  ...
  private boolean jj_3R_84() {
    if (jj_scan_token(CBYTE_VAR)) return true;
    return false;
  }
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x0,0x0,0xffe8c000,0x200000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xffe8c000,0x0,0x0,0x0,0x3e8c000,0x0,0x0,0x0,0xfc000000,0x40000000,0xbc000000,0xffe8c000,0x0,0xffe8c000,0xffe8c000,0x0,0x0,0x0,0x3e8c000,0x0,0xffe8c000,0x0,0x0,0xffe8c000,0x0,0xffe8c000,0xffe8c000,0xffe8c000,0xffe8c000,0xffe8c000,0xffe8c000,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0xb184027f,0x40,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4000000,0xc000000,0xc000000,0x0,0x80,0x100,0xc00,0xc00,0x3f000,0x3f000,0xc0000,0xc0000,0x700000,0x700000,0x8184027f,0x1840200,0x1800000,0x1800000,0x80000040,0x0,0x100000,0x0,0x3f,0x0,0x3f,0x8184027f,0x0,0x8184027f,0x8184027f,0x0,0x0,0x0,0x40,0x0,0x9184027f,0x0,0x0,0x9184027f,0x0,0x8184027f,0x8184027f,0x8184027f,0x8184027f,0x8184027f,0x8184027f,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x20000000,0x80fff0,0x476c0000,0x0,0x800000,0x0,0xfff0,0x2fff0,0x0,0x0,0x1ff0,0xe000,0x0,0x1ff0,0x0,0x0,0x0,0x4,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2,0x0,0x2,0x0,0x0,0x0,0x1ff0,0x0,0x1ff0,0x1ff0,0x1ff0,0x0,0x0,0x0,0x0,0x476c0000,0x88000000,0x88000000,0x476cfff0,0xfff0,0x0,0xfff0,0x0,0x0,0x0,0x0,0x0,0x430,0x0,0x0,};
   }
   private static void jj_la1_init_3() {
      jj_la1_3 = new int[] {0x0,0x20000000,0x220000f9,0x0,0x0,0x0,0x20000000,0x20000000,0x0,0x20000000,0x0,0x20000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x220000f8,0x0,0x0,0x0,0x220000f8,0x0,0x20000000,0x0,0x20000000,0x20000000,0x0,0x223ffff8,0x0,0x223ffff8,0x223ffff8,0x3fff00,0x3fc000,0x3f00,0x0,0x0,0x220000f9,0x0,0x0,0x220000f9,0x20000000,0x220000f8,0x220000f8,0x220000f8,0x220000f8,0x23c000f8,0x23c000f8,0x1c00000,0x0,0x0,0x78,};
   }
   private static void jj_la1_init_4() {
      jj_la1_4 = new int[] {0x0,0x0,0x2,0x0,0x0,0x1,0x0,0x0,0x1,0x0,0x0,0x0,0x2,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2,0x0,0x0,0x0,0x2,0x2,0x0,0x2,0x0,0x0,0x0,0x2,0x1,0x2,0x2,0x0,0x0,0x0,0x2,0x1,0x2,0x0,0x0,0x2,0x0,0x2,0x2,0x2,0x2,0x2,0x2,0x0,0x0,0x1,0x0,};
   }
