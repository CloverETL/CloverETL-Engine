...
<TestScenario ident="RealWorldExamples" description="RealWorldExamples distributed with Designer" useJMX="true">
	...
	<FunctionalTest ident="ValidateData" graphFile="graph/ValidateData.grf" excludedContainers="websphere7,jetty9">
	...
	<FunctionalTest ident="ValidateData_v2" graphFile="graph/ValidateData.grf" excludedContainers="tomcat6,weblogic10,weblogic12,jboss6,jboss7,glassfish3" excludedEtlEnvironment="engine,cluster">
