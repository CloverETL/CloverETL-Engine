...
public class RangeLookupTest extends TestCase {
	...
	public void test_getDataRecord() throws IOException, ComponentNotReadyException {
		...
		lookup = LookupTableFactory.createLookupTable(null, "rangeLookup", new Object[] { "RangeLookup", lookupMetadata, new String[] { "start", "start1" }, new String[] { "end", "end1" }, null }, new Class[] { String.class, DataRecordMetadata.class, String[].class, String[].class, Parser.class });
		lookupNotOverlap = LookupTableFactory.createLookupTable(null, "rangeLookup", new Object[] { "RangeLookup", lookupMetadata, new String[] { "start", "start1" }, new String[] { "end", "end1" }, null }, new Class[] { String.class, DataRecordMetadata.class, String[].class, String[].class, Parser.class });
		lookup.init();
	...
	public void test_getDataRecord2() throws IOException, ComponentNotReadyException {
		...
		lookupMetadata.addField(new DataFieldMetadata("start1", DataFieldMetadata.INTEGER_FIELD, ";"));
		lookupMetadata.addField(new DataFieldMetadata("end1", DataFieldMetadata.INTEGER_FIELD, ";"));
		lookup = LookupTableFactory.createLookupTable(null, "rangeLookup", new Object[] { "RangeLookup", lookupMetadata, new String[] { "start1", "start" }, new String[] { "end", "end1" }, null }, new Class[] { String.class, DataRecordMetadata.class, String[].class, String[].class, Parser.class });
		lookupNotOverlap = LookupTableFactory.createLookupTable(null, "rangeLookup", new Object[] { "RangeLookup", lookupMetadata, new String[] { "start1", "start" }, new String[] { "end", "end1" }, null }, new Class[] { String.class, DataRecordMetadata.class, String[].class, String[].class, Parser.class });
		lookup.init();
		lookupNotOverlap.init();
		record = new DataRecord(lookupMetadata);
		record.init();
	...
	public void test_largeData() throws IOException, ComponentNotReadyException, JetelException {
		...
		lookup = LookupTableFactory.createLookupTable(null, "rangeLookup", new Object[] { "RangeLookup", lookupMetadata, new String[] { "s1", "s2", "s3", "s4", "s5", "s6", "s7", "s8" }, new String[] { "e1", "e2", "e3", "e4", "e5", "e6", "e7", "e8" }, parser }, new Class[] { String.class, DataRecordMetadata.class, String[].class, String[].class, Parser.class });
		lookup.init();
	...
	public void test_getString() throws ComponentNotReadyException {
		...
		lookup = LookupTableFactory.createLookupTable(null, "rangeLookup", new Object[] { "RangeLookup", lookupMetadata, new String[] { "start" }, new String[] { "end" }, null }, new Class[] { String.class, DataRecordMetadata.class, String[].class, String[].class, Parser.class });
		lookup.init();
		record = new DataRecord(lookupMetadata);
		record.init();
	...
	public void test_Strings() throws ComponentNotReadyException {
		...
		lookup = LookupTableFactory.createLookupTable(null, "rangeLookup", new Object[] { "RangeLookup", lookupMetadata, new String[] { "start" }, new String[] { "end" }, null, collator }, new Class[] { String.class, DataRecordMetadata.class, String[].class, String[].class, Parser.class, RuleBasedCollator.class });
		lookup.init();
		record = new DataRecord(lookupMetadata);
		record.init();
		record.getField("name").setValue("p1");
