 ...
 */
public class PolicyReferenceExtensionDeserializer implements ExtensionDeserializer {
    ...
    public ExtensibilityElement unmarshall(Class parentType, QName extensionType, Element extensionElement, Definition definition, ExtensionRegistry registry) throws WSDLException {
        PolicyReferenceExtension extension = (PolicyReferenceExtension) registry.createExtension(parentType, extensionType);
