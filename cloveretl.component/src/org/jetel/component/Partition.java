...
public class Partition extends Node {
	...
	private void executeNonDirect(InputPortDirect inPort,
		...
		inRecord.init();
		CloverBuffer inRecordDirect = CloverBuffer.allocateDirect(Defaults.Record.INITIAL_RECORD_SIZE, Defaults.Record.RECORD_SIZE_LIMIT);
	...
	private void executeDirect(InputPortDirect inPort, OutputPortDirect[] outPorts) throws Exception {
		CloverBuffer inRecord = CloverBuffer.allocateDirect(Defaults.Record.INITIAL_RECORD_SIZE, Defaults.Record.RECORD_SIZE_LIMIT);
