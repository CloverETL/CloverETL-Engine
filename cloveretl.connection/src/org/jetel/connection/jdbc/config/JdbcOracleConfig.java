...
public class JdbcOracleConfig extends JdbcBaseConfig {

	private static JdbcOracleConfig instance=new JdbcOracleConfig(AutoGeneratedKeysType.MULTI);

	private JdbcOracleConfig(AutoGeneratedKeysType multi) {
		super(multi);
	}

	public static JdbcOracleConfig getInstance(){
		return instance;
	}
